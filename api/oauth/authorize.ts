...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    input:focus {
      box-shadow: inset 3px 3px 6px #b8bec7, inset -3px -3px 6px #ffffff, 0 0 0 2px #6C63FF40;
    }
    button {
      width: 100%;
      margin-top: 24px;
    ...
    button:active {
      ...
      box-shadow: 2px 2px 4px #b8bec7, -1px -1px 2px #ffffff;
    }
    .info {
      text-align: center;
      margin-top: 20px;
...
<body>
  <div class="card">
    ...
    <p class="info">
      Sign in with your Task Buddy account to grant<br/>
      this AI agent access to your tasks and lists.
    </p>
  </div>
</body>
</html>`);
